...
const Navbar = () => {
  return (
    <nav className="relative px-4 md:px-10 py-2 bg-[#FFFFFF] text-[#212121]">
      ...
      <div
        className="w-24 md:w-1/4 h-32 md:h-32 bg-[#f5f3f3] z-10 shadow-xl drop-shadow-xl absolute left-16  md:left-10 -translate-x-1/2 md:translate-x-0 md:-top-8 flex items-center justify-center"
        style={{
