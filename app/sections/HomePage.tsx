    ...
    <section className="grid grid-cols-1 gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-8 px-4 md:px-12 gap-8">
        <div className="relative mx-auto md:mx-0 mb-8 md:mb-0">
          <div className="absolute top-10 left-4 md:left-32 w-1/2 h-5/6 bg-[#789336] rounded-md z-0"></div>
        ...
        <div className="flex flex-col justify-center px-4 md:px-0">
          ...
          <div className="flex justify-center md:justify-start">
            <Button className="bg-white text-[#789336] border border-[#789336] px-6 py-2 text-sm rounded hover:bg-gray-100 transition-colors">
              LEARN MORE
            </Button>
          </div>
        </div>
